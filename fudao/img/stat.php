...
(function () {
    ...
    setCookie("stat_mac", "D1443793824ED19A", 1, location.hostname);
    var a = encodeURIComponent(document.referrer);
    var b = encodeURIComponent(document.location.href);
    if (c == 1) {
        callScript(protocol + "//stat.xiaonaodai.com/u.php?id=10934099&b=" + c + "&m=D1443793824ED19A&h=" + b + "&t=" + Math.random() + "&r=" + a, "utf-8", 1)
    } else {
        callRequest(protocol + "//stat.xiaonaodai.com/u.php?id=10934099&b=" + c + "&m=D1443793824ED19A&h=" + b + "&t=" + Math.random() + "&r=" + a)
    }
})();
